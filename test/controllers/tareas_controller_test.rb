...
class TareasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tarea" do
    assert_difference('Tarea.count') do
      post tareas_url, params: { tarea: { finalizada: @tarea.finalizada, titulo: @tarea.titulo } }, as: :json
    end
  ...
  test "should update tarea" do
    patch tarea_url(@tarea), params: { tarea: { finalizada: @tarea.finalizada, titulo: @tarea.titulo } }, as: :json
    assert_response 200
  end
